...
class Profile(BaseModel):
    id: str = "default"
    name: str = "Athlete"
    goal: str = "strength"  # strength | hypertrophy | weight_loss | endurance
...
async def parse_workout(req: ParseRequest):
    ...
    system = (
        ...
        '  "exercises": [\n'
        "    {\n"
        '      "name": string,           // canonical exercise name; pick closest match from the list\n'
        '      "muscle_group": string,   // e.g. chest, back, legs, shoulders, arms, core\n'
